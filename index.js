...
let owners = '1059818987803906128'//ايدي الي هيتحول 
let owner;
const
  updateAdmins = () => {
  owner = db.get("admins")
  owners = '1059818987803906128'
  owner.unshift('1233715546181079045')//اي دي حقك
}
updateAdmins()
...
client.on('guildCreate', guild => {
  ...
  let textList = ["$Stock" , `${prefix}help` , "BY w.z4"]
...
`)
    ...
    if (command === "buy") {
      ...
      let buys = new Discord.MessageEmbed()
        ...
        .setTimestamp()
        .addField(`**شراء ${account} نيترو :**`
          ,
          `
            
            > **-عدد نيتروهات :** \`${numOfAcc}\`
